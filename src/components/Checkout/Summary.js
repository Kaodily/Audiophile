...
const Summary = () => {
  ...
  return (
    <div className="mx-5 shadow-md my-12 rounded-md py-8 lg:my-5 bg-white">
      ...
      <Total name="GRAND TOTAL" price="0"/>
        <button className="w-[18rem] lg:w-[20rem] text-[14px] tracking-widest text-white h-[50px] bg-[#fbaf85]">
          CONTINUE AND PAY
        </button>
      </div>
        </div>
