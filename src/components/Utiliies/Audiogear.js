const Audiogear = () => {
    return (
        <div className="mt-28 sm:pb-7  mb-16 text-center lg:mx-[6%] lg:grid gap-7 grid-cols-2">
            ...
            <h3 className="uppercase mt-9 mb-5  text-[20px] sm:text-[26px] lg:text-left sm:px-[150px] lg:px-[0] tracking-widest font-bold text-center px-20">Bringing you the <span className="text-[#D87D4A]">best</span> audio gear</h3>
