const Audiogear = () => {
    return (
        <div className="mt-20 sm:pb-7 mb-8 text-center">
            <div className="audiogear h-[300px] sm:h-[400px] mx-[30px] rounded-md px-8 py-12 text-black ">
            </div>
            <h3 className="uppercase mt-9 mb-5 text-[20px] sm:text-[30px] sm:px-[150px]  tracking-widest font-bold text-center px-20">Bringing you the <span className="text-[#D87D4A]">best</span> audio gear</h3>
