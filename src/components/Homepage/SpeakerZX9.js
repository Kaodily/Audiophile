...
const SpeakerZX9 = () => {
    return (
        <div className="pattern h-[500px] sm:h-[580px] lg:flex lg:justify-between  mt-16 bg-[#D87D4A] mx-[30px] lg:mx-[9%] py-8 rounded-md lg:text-left text-white text-center ">
            <div>
            <img src='../assets/home/desktop/image-speaker-zx9.png' className='w-[150px] sm:w-[200px] lg:w-[380px] mx-auto pt-3 lg:pt-[90px] lg:ml-[100px]' alt="speakerzx9" />
            </div>
