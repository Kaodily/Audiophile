...
const SpeakerZX9 = () => {
    return (
        <div className="pattern h-[500px] sm:h-[580px] lg:flex  bg-[#D87D4A] mx-[170px] py-8 rounded-md text-white text-center ">
            <div>
            ...
            <div>
            <h2 className='text-center text-[22px] mt-[-30px] font-bold sm:px-[190px] sm:text-[36px] md:px-[250px] tracking-widest px-[100px] '>ZX9 SPEAKER</h2>
