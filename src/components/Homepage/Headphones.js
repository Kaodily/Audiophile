...
const Headphones = () => {
    return (
        <article className="article h-[580px] sm:h-[700px] text-center lg:text-left py-[180px] text-white"  >
            ...
            <p className='px-[50px] text-[14px] sm:text-[20px] lg:max-w-3xl sm:px-[120px] lg:px-[180px] opacity-50'>Experience natural, lifelike audio and exceptional build quality made for the passionate music enthusiast.</p>
