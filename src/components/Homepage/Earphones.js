...
export const Earphones = () => {
    return (
        <div className="earphones h-[200px] sm:col-span-2 mt-6 mx-[30px] sm:mx-[0] sm:mr-[10px] sm:ml-[30px] pt-24 px-9 rounded-md text-black  ">
       </div>
    )
}
export const EarphonesInformation = () => {
    return (
        <div className="h-[200px] mt-6 mx-[30px] rounded-md px-8 sm:col-span-2 sm:mx-[0] sm:ml-[10px] sm:mr-[30px] sm:py-9  py-12 text-black bg-[#F1F1F1]  ">
