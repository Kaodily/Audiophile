...
const Details = () => {
    const {filtered,handleClick} = useContext(DataContext)
                           ...
                           <div className="text-left">
                                 ...
                                 {product.description}
                                        ...
                                        <div className="flex pl-9">
                                            ...
                                            <button className="uppercase w-[150px] font-medium text-[14px] mx-2 text-white h-[40px] bg-[#D87D4A]" onClick ={()=>handleClick(product.name)}>ADD TO CART</button>
                                        </div>
                            ...
                            { product.includes.map((content, index) => {
                              return(<div key={index} className='flex list-none pl-9 mb-1' >
                             ...
                             <li className="pl-3 lading-6 font-medium text-[14px] opacity-50">{content.item}</li>
                                    ...
                                    <div  className="mx-[20px] rounded-md px-8 py-4 text-black  ">
                                       <img  className='rounded-md mb-4' src={`${'.'}${product.gallery.first.mobile}`} alt={product.name} />
                                       <img  className='rounded-md mb-4' src={`${'.'}${product.gallery.second.mobile}`} alt={product.name} />
                                       <img  className='rounded-md mb-4' src={`${'.'}${product.gallery.third.mobile}`} alt={product.name} />
                                    </div>
                                </div>   
                )
            }
